...
# rust.sh -- the rust language fragment for the break-stuff base image.
#
...
# nightly; clippy ships inside the toolchain. cargo-fuzz and cargo-audit are the rust
# code/robustness tools on top.
#
